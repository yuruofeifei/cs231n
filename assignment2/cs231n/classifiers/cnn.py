...
class ThreeLayerConvNet(object):
    ...
    def loss(self, X, y=None):
        ...
        affine_dout, affine_dw, affine_db = affine_backward(dout, affine_cache)
        grads['W3'] = affine_dw + self.reg * self.params['W3']
        grads['b3'] = affine_db
        affine_relu_dout, affine_relu_dw, affine_relu_db = affine_relu_backward(affine_dout, affine_relu_cache)
        grads['W2'] = affine_relu_dw + self.reg * self.params['W2']
        grads['b2'] = affine_relu_db
        conv_relu_pool_dout, conv_relu_pool_dw, conv_relu_pool_db = conv_relu_pool_backward(affine_relu_dout, conv_relu_pool_cache)
        grads['W1'] = conv_relu_pool_dw + self.reg * self.params['W1']
        grads['b1'] = conv_relu_pool_db
